...
public class MissingNum {
		...
		public static ArrayList<Integer> repeatedNumber(final List<Integer> a) {
		    ...
		    int length=a.size();
		    double actualSum=(length*(length+1))/2;
		    double actualProd=1l;
		    for(int i=1;i<=length;i++)
		        actualProd*=i;
		        
		   double c=sum-actualSum;
		   
		   double d=0.0;
//		   d=actualProd>prod ? actualProd/prod:prod/actualProd;0
		   d=prod/actualProd;
		   double b= (c/(d-1));
		   double e= (b*d);
		   
		   ArrayList<Integer> out=new ArrayList<Integer>(2);
		   out.add((int)Math.ceil(e));
		   out.add((int)Math.ceil(b));
		...
		public static ArrayList<Integer> maxSet(ArrayList<Integer> a) {
		    ...
		    for(int i=0;i<a.size();i++)
		    {
		       ...
		       else if(currSum!=0&&currSum==maxSum)
		       {
		    	   currEnd=i-1;
